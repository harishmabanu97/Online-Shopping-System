									...
									<tbody>
										<tr>
											...
											<td><a
												...
												<td><a
												href="admin-edit-customer.jsp?id=<%=resultSet.getInt(1) %>"
												class="btn btn-danger" onclick="return confirm('Are you sure Do you want to edit this customer?');">Edit Record</a></td>
										</tr>
									</tbody>
									<%
										}
