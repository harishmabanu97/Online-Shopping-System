...
<!-- Mirrored from p.w3layouts.com/demos/apr-2016/05-04-2016/smart_shop/web/Home Appliances.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Jul 2020 05:57:48 GMT -->
<!-- Added by HTTrack -->
	...
	<div class="electronics">
		<div class="container">
			...
			<div class="ele-bottom-grid">
				<h3>
					<span>Fresh </span>Greens
				</h3>
				<%
					ResultSet retriveProduct = DatabaseConnection
						.getResultFromSqlQuery("select * from tblproduct where product_category='Veg & Fruits'");
