	...
	<div class="ban-top">
		...
		<br>
			<h3>                    About Us</h3>
							...
							<br><br><p style="position: relative; float: left; width: 1000px;">online
					Shopping City, multiple award-winning and most trusted chain
					of budget Website in India. One of the leading brands in the
					e-commerce segment, Shopping City has rapidly grown in major urban and
					semi-urban cities across India to be an ideal choice for Shopping Lovers.</p>
				
				<p style="position: relative; float: left; width: 1000px;">Buy
					a new things in India with Shopping City, where you can experience a
					unique blend of comfort, efficiency, convenience and affordability
					in warm, smart things.</p>
</div>
		</div>
	</div>
	<div class="header">
